                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8 col-md-10">
                        <div class="breadcrumb__wrap__content">
                            <h2 class="title">{{ $singlePortfolio->portfolio_name }}</h2>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">{{ $singlePortfolio->portfolio_title }}</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="services__details__thumb">
                            <img src="{{ asset($singlePortfolio->portfolio_image) }}" alt="">
                        </div>
                        <div class="services__details__content">
                            <h2 class="title">{{ $singlePortfolio->portfolio_name }}</h2>
                            <h4 class="">{{ $singlePortfolio->portfolio_title }}</h4>
                            <p>{!! $singlePortfolio->portfolio_description !!}</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
