                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('store.multi.image') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" multiple type="file" name="multi_image[]" id="about_image">
                                    </div>
                                </div>
                                ...
                                <input type="submit" name="submit"
                                    class="btn btn-info btn-rounded waves-effect waves-light" value="Add Multi Page">
                            </form>
