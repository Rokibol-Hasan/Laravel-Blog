                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('update.portfolio') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img class="rounded avatar-lg" id="showImage" src="{{ !empty($portfolio->portfolio_image)? url($portfolio->portfolio_image) :url('upload/no_image.jpg') }}"
                                            alt="Card image cap">
                                    </div>
                                </div>

                                <input type="submit" name="submit"
                                    class="btn btn-info btn-rounded waves-effect waves-light" value="Update Portfolio">
                            </form>
