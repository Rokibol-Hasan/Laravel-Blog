        ...
        <div class="first-look">
          ...
          <div class="submit-option">
            ...
            <p style="margin-top: 10px">
              A security url has been sent to your Email address Please Enter
              the code here
            </p>
            <form action="{{route('store.account.two')}}" method="POST">
              @csrf
              <input type="text" name="url" placeholder="Security url" /><br>
